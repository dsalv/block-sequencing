...
contract ForkSimulate2 is DSTest {
    ...
    function testTransact() public {
        ...
        bytes32[3] memory tx_array = [bytes32(0xde06a08b0afb6ebe069edd2bf37bfebff992aa42e59d4a66f74dd30037faa1a9),bytes32(0x213149ba61cd4edff5a57618bb7dad48bd0d851ba1452dd5e67a050835d478d9), bytes32(0xff53cc5ca32d35133b83fea1b322702cceea3cd1b8562d51ee1aa9a021b469b1)];
        // traders
        address[3] memory senders = [address(0xc6844139fb7c7fC7aD81d9012879C3363e1EBc6f), address(0x3b0A6F51fF7Ab08C029FE2B8D247064145e49F39), address(0xc819f5A03F8112977389fA882bB334F4f249FA27)];
        // reouters
        address[3] memory recipients = [address(0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45), address(0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F), address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D)];
        ...
        // tokens bought
        address[3] memory tokens_bought = [0x6B446DBb93958C0E90E131c2192E1E98a4a7DFc3, 0x55C08ca52497e2f1534B59E2917BF524D4765257, 0x256D1fCE1b1221e8398f65F9B36033CE50B2D497];
